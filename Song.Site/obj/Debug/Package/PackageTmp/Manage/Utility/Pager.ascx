...
<div class="pager">
    ...
    &nbsp;<span class="noprint">
    <asp:LinkButton ID="lbnFirst" runat="server" Text="首 页" OnClick="lbnFirst_Click"></asp:LinkButton>
    <asp:LinkButton ID="lbnPrevious" runat="server" Text="上一页" OnClick="lbnPrevious_Click"></asp:LinkButton>
    <asp:LinkButton ID="lbnNext" runat="server" Text="下一页" OnClick="lbnNext_Click"></asp:LinkButton>
    <asp:LinkButton ID="lbnLast" runat="server" Text="末 页" OnClick="lbnLast_Click"></asp:LinkButton>
