<%@ Page Language="C#" MasterPageFile="~/Manage/ManagePage.Master" AutoEventWireup="true" CodeBehind="DailyLogView.aspx.cs" Inherits="Song.Site.Manage.Common.DailyLogView" Title="无标题页" %>
