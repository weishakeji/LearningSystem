...
<asp:LinkButton id="lbDown" onclick="lbDown_Click" runat="server"  Enabled='<%# Container.DataItemIndex+1< ((List<Song.Entities.AddressSort>)GridView1.DataSource).Length %>'>下移</asp:LinkButton>
