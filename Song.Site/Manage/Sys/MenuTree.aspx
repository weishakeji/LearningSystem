      ...
      <div id="Panel">
        <div> 
          ...
          <form id="EditPanel" class="editpanel">
            ...
            <dd> 移动到：
              <select name="moveto">
                <% foreach (Song.Entities.ManageMenu mm in root)
               {
                   if (mm.MM_Id == id)
                   {             
                   %>
                <option value="<%= mm.MM_Id%>" selected="selected" style="background-color: #CCCCCC;"><%= mm.MM_Name%></option>
                <%}
                   else
                   {
                       %>
                <option value="<%= mm.MM_Id%>"><%= mm.MM_Name%></option>
                <%
                   }
               }%>
              </select>
