    ...
    <cc1:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" SelectBoxKeyName="SelectBox"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="详情">
                <ItemTemplate>
                    <a href="#" onclick="OpenWin('../money/Details_View.aspx?id=<%# WeiSha.Common.DataConvert.EncryptForBase64UrlEncode(Eval("Ma_ID").ToString())%>','<%# Eval("Ma_Source", "{0}")%>',600,400);return false;">
                        查看</a>
                </ItemTemplate>
