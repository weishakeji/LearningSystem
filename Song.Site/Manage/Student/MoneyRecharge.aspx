...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="server">
    ...
    <div>
        <fieldset>
            ...
            <div class="infoRow">
                请输入充值码与密码：
                <asp:TextBox ID="tbCode" runat="server" Width="300px"></asp:TextBox>
            </div>
            <div class="infoRow">
            ...
            <div class="mrRow">
                <div class="mrTitle">
                    &nbsp;</div>
                <div class="mrInput">
                    <cc1:Button ID="btnCode" runat="server" Text="充值" verify="true" group="para" OnClick="btnCode_Click"
        ...
        <fieldset id="onlinePay" runat="server">
            ...
            <div class="mrRow">
                <div class="mrTitle">
                    充值金额：</div>
                <div class="mrInput">
                    <asp:TextBox ID="tbMoney" CssClass="tbMoney" runat="server" Width="180px"></asp:TextBox><span
            ...
            <div class="mrRow">
                ...
                <div class="mrInput">
                    <asp:TextBox ID="tbVerCode" CssClass="tbMoney" runat="server" Width="80px"></asp:TextBox>
