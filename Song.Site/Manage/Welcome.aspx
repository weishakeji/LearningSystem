...
<body>
    ...
    <div class="ChartsArea">
        <div id="courCharts" class="charts" style="height: 400px; width: 45%;">
        </div>
        <div id="courChartsPie" class="charts"  style="height: 400px; width: 45%;">
        </div>
    </div>
     <div class="ChartsArea">
        <div id="accoutsCharts" class="charts" style="height: 400px; width: 95%;">
        </div>
       
    </div>
    <div class="ChartsArea"> <div id="quesCharts" class="charts"  style="height: 400px; width: 95%;">
        </div>
    </div>
    <%--数据输出--%>
    ...
    <div class="footer">
        <span>硬件环境：CPU<asp:Literal ID="ltHz" runat="server"></asp:Literal>GHz×<asp:Literal
            ID="ltCpucount" runat="server"></asp:Literal>
            内存<asp:Literal ID="ltRamSize" runat="server"></asp:Literal>Gb</span> <span>软件环境：
                <asp:Literal ID="ltOs" runat="server"></asp:Literal>
                IIS
                <asp:Literal ID="ltIISver" runat="server"></asp:Literal>
                .Net
                <asp:Literal ID="ltDotNetver" runat="server"></asp:Literal></span> <span>主机地址：<asp:Literal
                    ID="ltIp" runat="server"></asp:Literal></span> <span>物理路径：
                        <asp:Literal ID="ltPath" runat="server"></asp:Literal></span>
    </div>
    </form>
</body>
</html>
