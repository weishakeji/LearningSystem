...
namespace Song.Site.Pay.Weixin
{
    public partial class Html5Pay : System.Web.UI.Page
    {
        ...
        //返回页
        protected string rawurl = WeiSha.Common.Request.QueryString["rawurl"].String;
        ...
        protected string notify_url = string.Empty;   //回调地址  
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Request.ServerVariables["REQUEST_METHOD"] == "GET")
            {
                ...
                notify_url = retdomain + "Pay/Weixin/ResultNotifyPage.aspx";
            }
            //接收ajax请求
        ...
        public WxPayData JsApiPayPage()
        {
            ...
            try
            {
                ...
                //统一下单
                return jsApiPay.GetUnifiedOrderResult("MWEB", serial, appid, mchid, paykey, notify_url, buyer);                
