...
--将附件中的flv视频，改为mp4，flv已经不再使用
 ...
 --课程管理，增加课程类型的字段,默认为0
 --Cou_Type值含义，0：学练考全功能；1:仅视频学习；2仅试题练习与模拟测试;
 alter table [Course] add Cou_Type int NULL
go
update [Course] set Cou_Type=0
go
alter table [Course] ALTER COLUMN Cou_Type int not null