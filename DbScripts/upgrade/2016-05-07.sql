...
/****** Object:  Table [dbo].[ManageMenu]    Script Date: 05/07/2016 19:57:27 ******/
...
/****** Object:  Table [dbo].[Purview]    Script Date: 05/07/2016 19:57:39 ******/
...
GO
/****** Object:  Table [dbo].[LogForStudentStudy]    Script Date: 05/07/2016 19:55:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[LogForStudentStudy](
	[Lss_ID] [int] IDENTITY(1,1) NOT NULL,
	[Org_ID] [int] NOT NULL,
	[St_ID] [int] NOT NULL,
	...
	[Cou_ID] [int] NOT NULL,
	[Ol_ID] [int] NOT NULL,
	[Lss_UID] [nvarchar](255) NULL,
	[Lss_CrtTime] [datetime] NOT NULL,
	[Lss_PlayTime] [int] NOT NULL,
	[Lss_StudyTime] [int] NOT NULL,
	[Lss_TotalTime] [int] NOT NULL,
	[Lss_LastTime] [datetime] NOT NULL,
	[Lss_IP] [nvarchar](50) NULL,
	[Lss_Browser] [nvarchar](255) NULL,
	[Lss_Platform] [nvarchar](255) NULL,
	[Lss_OS] [nvarchar](255) NULL,
 CONSTRAINT [PK_LogForStudentStudy] PRIMARY KEY CLUSTERED 
(
	[Lss_ID] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
SET IDENTITY_INSERT [dbo].[LogForStudentStudy] ON
INSERT [dbo].[LogForStudentStudy] ([Lss_ID], [Org_ID], [St_ID], [St_AccName], [St_Name], [Cou_ID], [Ol_ID], [Lss_UID], [Lss_CrtTime], [Lss_PlayTime], [Lss_StudyTime], [Lss_TotalTime], [Lss_LastTime], [Lss_IP], [Lss_Browser], [Lss_Platform], [Lss_OS]) VALUES (1, 3, 1, N'13223040250', N'欧阳志学', 44, 60, N'26b039a89cdf1099fe57ed4deae7d0e9', CAST(0x0000A5FF0116A591 AS DateTime), 349769, 30, 937360, CAST(0x0000A5FF0116BF18 AS DateTime), N'::1', N'Chrome 47.0', N'PC', N'Windows 7')
INSERT [dbo].[LogForStudentStudy] ([Lss_ID], [Org_ID], [St_ID], [St_AccName], [St_Name], [Cou_ID], [Ol_ID], [Lss_UID], [Lss_CrtTime], [Lss_PlayTime], [Lss_StudyTime], [Lss_TotalTime], [Lss_LastTime], [Lss_IP], [Lss_Browser], [Lss_Platform], [Lss_OS]) VALUES (2, 3, 83, N'13012345678', N'sss', 44, 60, N'811a1e246b3d745411a14079207a264a', CAST(0x0000A5FF011B0F97 AS DateTime), 23530, 90, 937360, CAST(0x0000A5FF0146CF1E AS DateTime), N'::1', N'Chrome 47.0', N'PC', N'Windows 7')
INSERT [dbo].[LogForStudentStudy] ([Lss_ID], [Org_ID], [St_ID], [St_AccName], [St_Name], [Cou_ID], [Ol_ID], [Lss_UID], [Lss_CrtTime], [Lss_PlayTime], [Lss_StudyTime], [Lss_TotalTime], [Lss_LastTime], [Lss_IP], [Lss_Browser], [Lss_Platform], [Lss_OS]) VALUES (3, 3, 83, N'13012345678', N'sss', 44, 80, N'6a6d688305dd742488ff282975520a11', CAST(0x0000A5FF011C5082 AS DateTime), 0, 140, 0, CAST(0x0000A5FF011EA310 AS DateTime), N'::1', N'Chrome 47.0', N'PC', N'Windows 7')
INSERT [dbo].[LogForStudentStudy] ([Lss_ID], [Org_ID], [St_ID], [St_AccName], [St_Name], [Cou_ID], [Ol_ID], [Lss_UID], [Lss_CrtTime], [Lss_PlayTime], [Lss_StudyTime], [Lss_TotalTime], [Lss_LastTime], [Lss_IP], [Lss_Browser], [Lss_Platform], [Lss_OS]) VALUES (4, 3, 83, N'13012345678', N'sss', 24, 41, N'e708e072bd5dff54ce095e80be0470a5', CAST(0x0000A5FF011EBCB8 AS DateTime), 34268, 40, 937360, CAST(0x0000A5FF01359967 AS DateTime), N'::1', N'Chrome 47.0', N'PC', N'Windows 7')
SET IDENTITY_INSERT [dbo].[LogForStudentStudy] OFF
/****** Object:  Table [dbo].[Purview]    Script Date: 05/07/2016 19:55:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4781, NULL, NULL, NULL, 522, N'half', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4782, NULL, NULL, NULL, 526, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4783, NULL, NULL, NULL, 537, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4784, NULL, NULL, NULL, 538, N'sel', N'organ', -1, NULL)
...
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4785, NULL, NULL, NULL, 536, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4786, NULL, NULL, NULL, 525, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4787, NULL, NULL, NULL, 535, N'sel', N'organ', -1, NULL)
...
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4788, NULL, NULL, NULL, 544, N'sel', N'organ', -1, NULL)
...
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4789, NULL, NULL, NULL, 621, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4790, NULL, NULL, NULL, 545, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4791, NULL, NULL, NULL, 527, N'half', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4792, NULL, NULL, NULL, 539, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4793, NULL, NULL, NULL, 627, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4794, NULL, NULL, NULL, 523, N'half', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4795, NULL, NULL, NULL, 623, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4796, NULL, NULL, NULL, 524, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4797, NULL, NULL, NULL, 610, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4798, NULL, NULL, NULL, 609, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4799, NULL, NULL, NULL, 528, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4800, NULL, NULL, NULL, 546, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4801, NULL, NULL, NULL, 624, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4802, NULL, NULL, NULL, 607, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4803, NULL, NULL, NULL, 618, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4804, NULL, NULL, NULL, 619, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4805, NULL, NULL, NULL, 565, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4806, NULL, NULL, NULL, 530, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4807, NULL, NULL, NULL, 532, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4808, NULL, NULL, NULL, 566, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4809, NULL, NULL, NULL, 568, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4810, NULL, NULL, NULL, 547, N'half', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4811, NULL, NULL, NULL, 548, N'half', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4812, NULL, NULL, NULL, 550, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4813, NULL, NULL, NULL, 552, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4814, NULL, NULL, NULL, 553, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4815, NULL, NULL, NULL, 554, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4816, NULL, NULL, NULL, 628, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4817, NULL, NULL, NULL, 629, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4818, NULL, NULL, NULL, 561, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4819, NULL, NULL, NULL, 562, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4820, NULL, NULL, NULL, 563, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4821, NULL, NULL, NULL, 564, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4822, NULL, NULL, NULL, 569, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4823, NULL, NULL, NULL, 570, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4824, NULL, NULL, NULL, 572, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4825, NULL, NULL, NULL, 622, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4826, NULL, NULL, NULL, 626, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4827, NULL, NULL, NULL, 574, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4828, NULL, NULL, NULL, 576, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4829, NULL, NULL, NULL, 580, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4830, NULL, NULL, NULL, 577, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4831, NULL, NULL, NULL, 593, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4832, NULL, NULL, NULL, 594, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4833, NULL, NULL, NULL, 595, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4834, NULL, NULL, NULL, 596, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4835, NULL, NULL, NULL, 597, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4836, NULL, NULL, NULL, 598, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4837, NULL, NULL, NULL, 625, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4838, NULL, NULL, NULL, 588, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4839, NULL, NULL, NULL, 589, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4840, NULL, NULL, NULL, 600, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4841, NULL, NULL, NULL, 590, N'sel', N'organ', -1, NULL)
INSERT [dbo].[Purview] ([Pur_Id], [Dep_Id], [EGrp_Id], [Posi_Id], [MM_Id], [Pur_State], [Pur_Type], [Org_ID], [Olv_ID]) VALUES (4842, NULL, NULL, NULL, 591, N'sel', N'organ', -1, NULL)
...
/****** Object:  Table [dbo].[ManageMenu]    Script Date: 05/07/2016 19:55:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[ManageMenu] ([MM_Id], [MM_Name], [MM_Type], [MM_Root], [MM_Link], [MM_Marker], [MM_Tax], [MM_PatId], [MM_Color], [MM_Font], [MM_IsBold], [MM_IsItalic], [MM_IcoS], [MM_IcoB], [MM_IsUse], [MM_IsShow], [MM_Intro], [MM_State], [MM_Func], [MM_WinWidth], [MM_WinHeight], [MM_IcoX], [MM_IcoY]) VALUES (627, N'学员在线', N'item', 522, N'/manage/admin/stonline.aspx', N'', 91, 527, NULL, NULL, 0, 0, NULL, NULL, 1, 1, N'', 0, N'func', 400, 300, 90, 101)
INSERT [dbo].[ManageMenu] ([MM_Id], [MM_Name], [MM_Type], [MM_Root], [MM_Link], [MM_Marker], [MM_Tax], [MM_PatId], [MM_Color], [MM_Font], [MM_IsBold], [MM_IsItalic], [MM_IcoS], [MM_IcoB], [MM_IsUse], [MM_IsShow], [MM_Intro], [MM_State], [MM_Func], [MM_WinWidth], [MM_WinHeight], [MM_IcoX], [MM_IcoY]) VALUES (628, N'在线时间', N'item', 547, N'/manage/student/online.aspx', N'', 95, 548, NULL, NULL, 0, 0, NULL, NULL, 1, 1, N'', 0, N'func', 400, 300, 78, 164)
INSERT [dbo].[ManageMenu] ([MM_Id], [MM_Name], [MM_Type], [MM_Root], [MM_Link], [MM_Marker], [MM_Tax], [MM_PatId], [MM_Color], [MM_Font], [MM_IsBold], [MM_IsItalic], [MM_IcoS], [MM_IcoB], [MM_IsUse], [MM_IsShow], [MM_Intro], [MM_State], [MM_Func], [MM_WinWidth], [MM_WinHeight], [MM_IcoX], [MM_IcoY]) VALUES (629, N'学习记录', N'item', 547, N'/manage/student/studylog.aspx', N'', 96, 548, NULL, NULL, 0, 0, NULL, NULL, 1, 1, N'', 0, N'func', 400, 300, 101, 164)
...
INSERT [dbo].[ManageMenu] ([MM_Id], [MM_Name], [MM_Type], [MM_Root], [MM_Link], [MM_Marker], [MM_Tax], [MM_PatId], [MM_Color], [MM_Font], [MM_IsBold], [MM_IsItalic], [MM_IcoS], [MM_IcoB], [MM_IsUse], [MM_IsShow], [MM_Intro], [MM_State], [MM_Func], [MM_WinWidth], [MM_WinHeight], [MM_IcoX], [MM_IcoY]) VALUES (548, N'在线学习', N'item', 547, N'', N'', 100, 547, NULL, NULL, 0, 0, NULL, NULL, 1, 1, N'', 0, N'func', 400, 300, 32, 165)
INSERT [dbo].[ManageMenu] ([MM_Id], [MM_Name], [MM_Type], [MM_Root], [MM_Link], [MM_Marker], [MM_Tax], [MM_PatId], [MM_Color], [MM_Font], [MM_IsBold], [MM_IsItalic], [MM_IcoS], [MM_IcoB], [MM_IsUse], [MM_IsShow], [MM_Intro], [MM_State], [MM_Func], [MM_WinWidth], [MM_WinHeight], [MM_IcoX], [MM_IcoY]) VALUES (550, N'我的课程', N'item', 547, N'/manage/student/selfcourse.aspx', N'', 50, 548, NULL, NULL, 0, 0, NULL, NULL, 1, 1, N'已经选学的课程', 0, N'func', 400, 300, 32, 164)
INSERT [dbo].[ManageMenu] ([MM_Id], [MM_Name], [MM_Type], [MM_Root], [MM_Link], [MM_Marker], [MM_Tax], [MM_PatId], [MM_Color], [MM_Font], [MM_IsBold], [MM_IsItalic], [MM_IcoS], [MM_IcoB], [MM_IsUse], [MM_IsShow], [MM_Intro], [MM_State], [MM_Func], [MM_WinWidth], [MM_WinHeight], [MM_IcoX], [MM_IcoY]) VALUES (623, N'院系设置', N'item', 522, N'/manage/sys/Depart.aspx', N'', 240, 523, NULL, NULL, 0, 0, NULL, NULL, 1, 1, N'', 0, N'func', 400, 300, 90, 101)
INSERT [dbo].[ManageMenu] ([MM_Id], [MM_Name], [MM_Type], [MM_Root], [MM_Link], [MM_Marker], [MM_Tax], [MM_PatId], [MM_Color], [MM_Font], [MM_IsBold], [MM_IsItalic], [MM_IcoS], [MM_IcoB], [MM_IsUse], [MM_IsShow], [MM_Intro], [MM_State], [MM_Func], [MM_WinWidth], [MM_WinHeight], [MM_IcoX], [MM_IcoY]) VALUES (552, N'测试成绩', N'item', 547, N'/manage/exam/TestArchives.aspx', N'', 70, 548, NULL, NULL, 0, 0, NULL, NULL, 1, 1, N'已经选学的课程', 0, N'func', 400, 300, 84, 7)
INSERT [dbo].[ManageMenu] ([MM_Id], [MM_Name], [MM_Type], [MM_Root], [MM_Link], [MM_Marker], [MM_Tax], [MM_PatId], [MM_Color], [MM_Font], [MM_IsBold], [MM_IsItalic], [MM_IcoS], [MM_IcoB], [MM_IsUse], [MM_IsShow], [MM_Intro], [MM_State], [MM_Func], [MM_WinWidth], [MM_WinHeight], [MM_IcoX], [MM_IcoY]) VALUES (553, N'考试成绩', N'item', 547, N'/manage/exam/Archives.aspx', N'', 80, 548, NULL, NULL, 0, 0, NULL, NULL, 1, 1, N'已经选学的课程', 0, N'func', 400, 300, 125, 164)
INSERT [dbo].[ManageMenu] ([MM_Id], [MM_Name], [MM_Type], [MM_Root], [MM_Link], [MM_Marker], [MM_Tax], [MM_PatId], [MM_Color], [MM_Font], [MM_IsBold], [MM_IsItalic], [MM_IcoS], [MM_IcoB], [MM_IsUse], [MM_IsShow], [MM_Intro], [MM_State], [MM_Func], [MM_WinWidth], [MM_WinHeight], [MM_IcoX], [MM_IcoY]) VALUES (554, N'错题回顾', N'item', 547, N'/manage/student/QuesError.aspx', N'', 90, 548, NULL, NULL, 0, 0, NULL, NULL, 1, 1, N'已经选学的课程', 0, N'func', 400, 300, 187, 101)
INSERT [dbo].[ManageMenu] ([MM_Id], [MM_Name], [MM_Type], [MM_Root], [MM_Link], [MM_Marker], [MM_Tax], [MM_PatId], [MM_Color], [MM_Font], [MM_IsBold], [MM_IsItalic], [MM_IcoS], [MM_IcoB], [MM_IsUse], [MM_IsShow], [MM_Intro], [MM_State], [MM_Func], [MM_WinWidth], [MM_WinHeight], [MM_IcoX], [MM_IcoY]) VALUES (556, N'参加考试', N'item', 547, N'/manage/exam/SelfExam.aspx', N'', 60, 548, NULL, NULL, 0, 0, NULL, NULL, 1, 1, N'已经选学的课程', 0, N'func', 400, 300, 162, 100)
INSERT [dbo].[ManageMenu] ([MM_Id], [MM_Name], [MM_Type], [MM_Root], [MM_Link], [MM_Marker], [MM_Tax], [MM_PatId], [MM_Color], [MM_Font], [MM_IsBold], [MM_IsItalic], [MM_IcoS], [MM_IcoB], [MM_IsUse], [MM_IsShow], [MM_Intro], [MM_State], [MM_Func], [MM_WinWidth], [MM_WinHeight], [MM_IcoX], [MM_IcoY]) VALUES (624, N'其它', N'item', 522, N'', N'', 320, 522, NULL, NULL, 0, 0, NULL, NULL, 1, 1, N'', 0, N'func', 400, 300, 90, 101)
INSERT [dbo].[ManageMenu] ([MM_Id], [MM_Name], [MM_Type], [MM_Root], [MM_Link], [MM_Marker], [MM_Tax], [MM_PatId], [MM_Color], [MM_Font], [MM_IsBold], [MM_IsItalic], [MM_IcoS], [MM_IcoB], [MM_IsUse], [MM_IsShow], [MM_Intro], [MM_State], [MM_Func], [MM_WinWidth], [MM_WinHeight], [MM_IcoX], [MM_IcoY]) VALUES (561, N'个人信息', N'item', 547, N'', N'', 110, 547, NULL, NULL, 0, 0, NULL, NULL, 1, 1, N'已经选学的课程', 0, N'func', 400, 300, 106, 69)
INSERT [dbo].[ManageMenu] ([MM_Id], [MM_Name], [MM_Type], [MM_Root], [MM_Link], [MM_Marker], [MM_Tax], [MM_PatId], [MM_Color], [MM_Font], [MM_IsBold], [MM_IsItalic], [MM_IcoS], [MM_IcoB], [MM_IsUse], [MM_IsShow], [MM_Intro], [MM_State], [MM_Func], [MM_WinWidth], [MM_WinHeight], [MM_IcoX], [MM_IcoY]) VALUES (562, N'基本信息', N'item', 547, N'/manage/student/info.aspx', N'', 10, 561, NULL, NULL, 0, 0, NULL, NULL, 1, 1, N'已经选学的课程', 0, N'func', 400, 300, 186, 132)
INSERT [dbo].[ManageMenu] ([MM_Id], [MM_Name], [MM_Type], [MM_Root], [MM_Link], [MM_Marker], [MM_Tax], [MM_PatId], [MM_Color], [MM_Font], [MM_IsBold], [MM_IsItalic], [MM_IcoS], [MM_IcoB], [MM_IsUse], [MM_IsShow], [MM_Intro], [MM_State], [MM_Func], [MM_WinWidth], [MM_WinHeight], [MM_IcoX], [MM_IcoY]) VALUES (563, N'联系方式', N'item', 547, N'/manage/student/link.aspx', N'', 20, 561, NULL, NULL, 0, 0, NULL, NULL, 1, 1, N'已经选学的课程', 0, N'func', 400, 300, 210, 133)
INSERT [dbo].[ManageMenu] ([MM_Id], [MM_Name], [MM_Type], [MM_Root], [MM_Link], [MM_Marker], [MM_Tax], [MM_PatId], [MM_Color], [MM_Font], [MM_IsBold], [MM_IsItalic], [MM_IcoS], [MM_IcoB], [MM_IsUse], [MM_IsShow], [MM_Intro], [MM_State], [MM_Func], [MM_WinWidth], [MM_WinHeight], [MM_IcoX], [MM_IcoY]) VALUES (564, N'安全管理', N'item', 547, N'/manage/student/safe.aspx', N'', 30, 561, NULL, NULL, 0, 0, NULL, NULL, 1, 1, N'已经选学的课程', 0, N'func', 400, 300, 57, 199)
...
INSERT [dbo].[ManageMenu] ([MM_Id], [MM_Name], [MM_Type], [MM_Root], [MM_Link], [MM_Marker], [MM_Tax], [MM_PatId], [MM_Color], [MM_Font], [MM_IsBold], [MM_IsItalic], [MM_IcoS], [MM_IcoB], [MM_IsUse], [MM_IsShow], [MM_Intro], [MM_State], [MM_Func], [MM_WinWidth], [MM_WinHeight], [MM_IcoX], [MM_IcoY]) VALUES (527, N'统计分析', N'item', 522, N'', N'', 220, 522, NULL, NULL, 0, 0, NULL, NULL, 1, 1, N'', 0, N'func', 400, 300, 57, 132)
...
INSERT [dbo].[ManageMenu] ([MM_Id], [MM_Name], [MM_Type], [MM_Root], [MM_Link], [MM_Marker], [MM_Tax], [MM_PatId], [MM_Color], [MM_Font], [MM_IsBold], [MM_IsItalic], [MM_IcoS], [MM_IcoB], [MM_IsUse], [MM_IsShow], [MM_Intro], [MM_State], [MM_Func], [MM_WinWidth], [MM_WinHeight], [MM_IcoX], [MM_IcoY]) VALUES (539, N'热门课程', N'item', 522, N'/Manage/Admin/CourseHot.aspx', N'', 70, 527, NULL, NULL, 0, 0, NULL, NULL, 1, 1, N'选课最多的专业', 0, N'func', 400, 300, 83, 37)
INSERT [dbo].[ManageMenu] ([MM_Id], [MM_Name], [MM_Type], [MM_Root], [MM_Link], [MM_Marker], [MM_Tax], [MM_PatId], [MM_Color], [MM_Font], [MM_IsBold], [MM_IsItalic], [MM_IcoS], [MM_IcoB], [MM_IsUse], [MM_IsShow], [MM_Intro], [MM_State], [MM_Func], [MM_WinWidth], [MM_WinHeight], [MM_IcoX], [MM_IcoY]) VALUES (540, N'热门教师', N'item', 522, N'', N'', 80, 527, NULL, NULL, 0, 0, NULL, NULL, 1, 0, N'', 0, N'func', 400, 300, 59, 39)
INSERT [dbo].[ManageMenu] ([MM_Id], [MM_Name], [MM_Type], [MM_Root], [MM_Link], [MM_Marker], [MM_Tax], [MM_PatId], [MM_Color], [MM_Font], [MM_IsBold], [MM_IsItalic], [MM_IcoS], [MM_IcoB], [MM_IsUse], [MM_IsShow], [MM_Intro], [MM_State], [MM_Func], [MM_WinWidth], [MM_WinHeight], [MM_IcoX], [MM_IcoY]) VALUES (546, N'参数设置', N'item', 522, N'/manage/admin/organsetup.aspx', N'', 300, 523, NULL, NULL, 0, 0, NULL, NULL, 1, 0, N'', 0, N'func', 400, 300, 57, 71)
