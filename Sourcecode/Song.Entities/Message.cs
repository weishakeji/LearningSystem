namespace Song.Entities {
    	...
    	public partial class Message : WeiSha.Data.Entity {
    		...
    		public class _ {
    			...
    			/// <summary>
    			/// 字段名：Msg_ReadTime - 数据类型：DateTime(可空)
    			/// </summary>
