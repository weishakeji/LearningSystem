namespace Song.Entities {
    	...
    	public partial class Special : WeiSha.Data.Entity {
    		...
    		public class _ {
    			...
    			/// <summary>
    			/// 字段名：Sp_PushTime - 数据类型：DateTime(可空)
    			/// </summary>
