namespace Song.Entities {
    	...
    	public partial class TestResults : WeiSha.Data.Entity {
    		...
    		public class _ {
    			...
    			/// <summary>
    			/// 字段名：Tr_CrtTime - 数据类型：DateTime(可空)
    			/// </summary>
