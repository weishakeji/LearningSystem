namespace Song.Entities {
    	...
    	public partial class Notice : WeiSha.Data.Entity {
    		...
    		public class _ {
    			...
    			/// <summary>
    			/// 字段名：No_StartTime - 数据类型：DateTime(可空)
    			/// </summary>
