namespace Song.Entities {
    	...
    	public partial class Columns : WeiSha.Data.Entity {
    		...
    		protected Boolean _Col_IsChildren;
    		...
    		public Boolean Col_IsChildren {
    			get {
    				return this._Col_IsChildren;
    			}
    			set {
    				this.OnPropertyValueChange(_.Col_IsChildren, _Col_IsChildren, value);
    				this._Col_IsChildren = value;
    			}
    		}
    		...
    		protected override void SetValues(WeiSha.Data.IRowReader reader) {
    			...
    			if ((false == reader.IsDBNull(_.Col_IsChildren))) {
    				this._Col_IsChildren = reader.GetBoolean(_.Col_IsChildren);
    			}
    		...
    		public class _ {
    			...
    			/// </summary>
    			public static WeiSha.Data.Field Col_UID = new WeiSha.Data.Field<Columns>("Col_UID");
