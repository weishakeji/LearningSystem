...
namespace Song.ServiceInterfaces
{
    ...
    /// 管理后台的菜单
    /// </summary>
    public interface IDepart : WeiSha.Core.IBusinessInterface
    {
        /// <summary>
        /// 添加
        /// </summary>
        ...
        void Delete(string name, int orgid);
        /// <summary>
        /// 获取单一实体对象，按主键ID；
        /// </summary>
        /// <param name="identify">实体的主键</param>
        ...
        /// <returns></returns>
        Depart GetSingle(string name, int orgid);
        /// <summary>
        /// 获取当前对象的父级对象；
        /// </summary>
        ...
        /// <returns></returns>
        Depart GetParent(string name, int orgid);
        /// <summary>
        /// 获取对象；即所有院系；
        /// </summary>
        /// <returns></returns>
