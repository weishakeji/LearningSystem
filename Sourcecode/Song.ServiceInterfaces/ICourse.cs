...
namespace Song.ServiceInterfaces
{
    ...
    public interface ICourse : WeiSha.Core.IBusinessInterface
    {
        ...
        /// <returns></returns>
        bool CourseUpdate(int couid, Field[] fiels, object[] objs);
        /// <summary>
        /// 是否为直播课
        /// </summary>
        ...
        /// <param name="countSum"></param>
        /// <returns></returns>
        DataTable StudentPager(int couid, string acc,string name, int size, int index, out int countSum);
        /// <summary>
