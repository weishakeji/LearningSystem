...
namespace Song.ServiceInterfaces
{
    ...
    public interface IAccounts : WeiSha.Core.IBusinessInterface
    {
        ...
        /// <param name="countSum"></param>
        /// <returns></returns>
        MoneyAccount[] MoneyPager(int orgid, int stid,int type, DateTime? start, DateTime? end, int from, string search, int state, int size, int index, out int countSum);
        /// <summary>
        /// 分页获取资金流水；
        /// </summary>
        /// </summary>
        ...
        /// <param name="end">按时间检索区间，此为结束时间</param>
        /// <returns></returns>
        string MoneyRecords4Excel(string path, int type, int from, DateTime? start, DateTime? end);
        #endregion
