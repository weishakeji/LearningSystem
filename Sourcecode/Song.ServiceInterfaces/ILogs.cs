...
namespace Song.ServiceInterfaces
{
    ...
    /// 日志的管理
    /// </summary>
    public interface ILogs : WeiSha.Core.IBusinessInterface
    {
        #region 管理登录日志
        /// <summary>
        /// 增加登录日志
        /// </summary>
        /// <param name="admin">当前管理员对象</param>
        void AddLoginLogs(EmpAccount admin);
        /// <summary>
        /// 增加操作日志
        /// </summary>
        void AddOperateLogs(EmpAccount admin);
        /// <summary>
        /// 添加
        /// </summary>
        ...
        /// <returns></returns>
        LogForStudentQuestions QuestionAdd(int acid, long couid, long olid, int ques, int index);
        /// <summary>
        /// 修改练习记录
        /// </summary>
        /// <param name="acid">学员id</param>
        ...
        /// <param name="index">试题页面中的索引</param>
        /// <returns></returns>
        LogForStudentQuestions QuestionUpdate(int acid, long couid, long olid, int ques, int index);
        /// <summary>
        /// 获取练习记录
        /// </summary>
        ...
        /// <returns></returns>
        LogForStudentQuestions QuestionSingle(int acid, long couid, long olid);
        /// <summary>
        /// 删除学员的练习记录
        /// </summary>
        /// <param name="acid">学员Id</param>
        /// <param name="couid">课程id</param>
        /// <param name="olid">章节id</param>
        void QuestionDelete(int acid, long couid, long olid);
        #endregion
    }
}
