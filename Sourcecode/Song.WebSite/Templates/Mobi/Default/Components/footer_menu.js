    ...
    data: function () {
        return {
            default_menus: [
                ...
                { name: 'DeepSeek', url: '/mobi/llm', icon: 'e813', img: '/Utilities/Images/ai.png', size: 23, show: true },
                { name: '我的课程', url: '/mobi/Account/MyCourse', icon: 'e813', img: '', size: 23, show: false },
