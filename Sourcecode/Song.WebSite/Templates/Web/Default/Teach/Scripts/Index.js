    ...
    window.vapp = new Vue({
        ...
        methods: {
            ...
            updatePhoto: function () {
                ...
                $api.post('Teacher/ModifyPhoto', { 'entity': th.teacher, 'file': th.upfile }).then(function (req) {
            ...
            getmenus: function () {
                ...
                $api.cache('ManageMenu/OrganMarkerMenus', { 'marker': 'teacher' })
                    .then(function (req) {
            ...
            //name:iframe的name值
            //func:要执行的方法名
            fresh: function (name, func) {              
                var iframe = $dom('iframe[name=\'' + name + '\']');
                if (iframe.length > 0) {
