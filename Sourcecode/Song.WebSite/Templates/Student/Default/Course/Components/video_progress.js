...
Vue.component('video_progress', {
    ...
    methods: {
        ...
        viewDetail: function (item) {
            ...
            var url = '/Student/Course/VideoProgress.' + item.Cou_ID;
       ...
       <div><span><icon>&#xe761</icon>视频学习</span>
        ...
        <div class="progress">   
            <el-tooltip effect="light" content="点击进度条，查看详情" placement="bottom-end"> 
                ...
                :style="progress<100 ? 'width:calc(100% - 60px)' : 'width:100%'"></el-progress>   
            </el-tooltip>  
            <a v-if="progress<100" target="_blank" :href="'/web/course/detail.'+course.Cou_ID" class="continue"><icon>&#xe616</icon>继续</a>
        </div> 
    </div>`
});