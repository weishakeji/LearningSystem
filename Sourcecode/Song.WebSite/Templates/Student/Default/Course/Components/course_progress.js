...
Vue.component('course_progress', {
    ...
    template: `<div class="info_column">
        ...
        <div class="progress">         
            ...
            :style="progress<100 ? 'width:calc(100% - 80px)' : ''"></el-progress>          
        </div>
        <a v-if="progress<100" target="_blank" :href="'/web/course/detail.'+course.Cou_ID" class="continue"><icon>&#xe616</icon>继续学习</a>
    </div>`
});