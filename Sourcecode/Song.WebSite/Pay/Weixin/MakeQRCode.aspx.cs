    ...
    public partial class MakeQRCode : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(Request.QueryString["data"]))
            {
                ...
                //各项配置           
                WeiSha.Core.CustomConfig config = CustomConfig.Load(org.Org_Config);   //自定义配置项           
                ...
                //此注释只是为了编译通过
                //System.Drawing.Image image = WeiSha.Core.QrcodeHepler.Encode(str, 200, centerImg, "", "#fff");
