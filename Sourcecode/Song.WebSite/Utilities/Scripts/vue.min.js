...
document.addEventListener('contextmenu', (e) => {
    let target = e.target;  
    let contextmenu = target && target.__vue__ && target.__vue__._events && target.__vue__._events.contextmenu;
    while (contextmenu == null && target.tagName != 'BODY') {
        target = target && target.parentNode != null ? target.parentNode : null;
        contextmenu = target && target.__vue__ && target.__vue__._events && target.__vue__._events.contextmenu;
    }
