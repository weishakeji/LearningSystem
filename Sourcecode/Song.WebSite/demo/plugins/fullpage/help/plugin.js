...
(function () {
    ...
    var tab$3 = function () {
      let description = tinymce.OperationManualHtml || '<p><h1>操作手册<h2></p>';
      // console.log("1212")
      var body = {
        type: 'htmlpanel',
        presets: 'document',
    ...
    var parseCustomTabs = function (editor, customTabs) {
      ...
      var tabs = __assign((_a = {}, _a[shortcuts.name] = shortcuts, _a[nav.name] = nav, _a[cPTab.name] = cPTab,_a[feedTab.name] = feedTab ,_a), customTabs.get());
