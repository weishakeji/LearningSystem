...
namespace Song.ServiceImpls
{
    public class DepartCom :IDepart
    {
        ...
        public void Delete(string name, int orgid)
        {
        ...
        /// <param name="name">院系名称</param>
        /// <returns></returns>
        public Depart GetSingle(string name, int orgid)
        {          
        ...
        /// <returns></returns>
        public Depart GetParent(string name, int orgid)
        {
            Depart mm = this.GetSingle(name,orgid);
            if (mm == null)
            {
                return null;
            }
