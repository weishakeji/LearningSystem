...
namespace Song.ServiceImpls
{
    public class LogsCom :ILogs
    {
        ...
        /// 增加登录日志
        /// </summary>
        public void AddLoginLogs(EmpAccount admin)
        {
            ...
            log.Log_Type = "login";
            log.Acc_Id = admin.Acc_Id;
            log.Acc_Name = admin.Acc_Name;
            log.Log_IP = WeiSha.Core.Browser.IP;
        ...
        /// 增加操作日志
        /// </summary>
        public void AddOperateLogs(EmpAccount admin)
        {
            System.Web.HttpContext _context = System.Web.HttpContext.Current;
            Song.Entities.Logs log = new Logs();
            //操作时间
